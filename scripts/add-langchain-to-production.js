...
async function addLangchainToProduction() {
  console.log('🚀 Add Langchain Historical Data to Production');
  console.log('==============================================');
  console.log('📤 Adding historical langchain-ai/langchain data to production...');
  console.log(`📊 Adding to prod-star-growth...`);

  const tableName = 'prod-star-growth';
...
// Run the script
addLangchainToProduction().catch(console.error); 